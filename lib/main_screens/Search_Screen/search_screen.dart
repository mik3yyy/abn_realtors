...
class _SearchScreenState extends State<SearchScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    Stream<QuerySnapshot> _categoryProductStream = FirebaseFirestore.instance
        ...
        .snapshots();
    Stream<QuerySnapshot> _searchProductStream =
        FirebaseFirestore.instance.collection('properties').snapshots();

    Stream<QuerySnapshot> _promoProductStream =
        FirebaseFirestore.instance.collection('properties').snapshots();
      ...
      onRefresh: () async {
        ...
        setState(() {
          _categoryProductStream = FirebaseFirestore.instance
              .collection('properties')
              .where('Categories',
                  arrayContains: postprovider.categories[currentinddex])
              .snapshots();
          _searchProductStream =
              FirebaseFirestore.instance.collection('properties').snapshots();
                                  ...
                                  return GestureDetector(
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                          ...
                                          color: currentinddex == index
                                              ? Constants.primaryColor
                                              : listingprovider.lightMode
                          ...
                          StreamBuilder<QuerySnapshot>(
                            ...
                            builder: (BuildContext context,
                              ...
                              List<QueryDocumentSnapshot<Object?>> products =
                                  snapshot.data!.docs;
                              Iterable<QueryDocumentSnapshot<Object?>>? result =
                                  snapshot.data!.docs;
