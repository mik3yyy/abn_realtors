  ...
  Widget build(BuildContext context) {
    ...
    void _pickImageFromGallery() async {
      try {
        ...
        MyMessageHandler.showSnackBar(_scaffoldKey, "Invalid images, prefered type");
      }
    }
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              ...
              actions: [
                MaterialButton(
                  onPressed: (){
                    ...
                    if(postprovider.title.isNotEmpty && postprovider.description.isNotEmpty && postprovider.imageFiles.isNotEmpty){
                      Navigator.push(context, MaterialPageRoute(builder: (context)=> PostApartment()));



                    }else {
                      MyMessageHandler.showSnackBar(_scaffoldKey, "Fill all field and add images");
              ...
              leading: IconButton(
                ...
                icon: Icon(Icons.cancel, color: Constants.primaryColor,),
              ) ,
              ...
              child: Column(
                children: [
                    ...
                    children: [
                      Expanded(
                          child: Container(
                            ...
                            child:postprovider.imageFiles.isEmpty? Center(
                              child: Text("No Image",
                                style: TextStyle(
                                  color: listingprovider.getForegroundColor(),
                                ...
                                GestureDetector(
                                  ...
                                  onDoubleTap: (){
                                    Navigator.push(context, MaterialPageRoute(builder: (context)=> ImageView(index: currentpage,) ));
                                  },
                                  child: Stack(
                                    children: [
                                      PageView.builder(
                                ...
                                MaterialButton(
                                  onPressed: (){
                                    ...
                                    if(postprovider.imageFiles.length < 10){
                                      ...
                                      MyMessageHandler.showSnackBar(_scaffoldKey, "Maximum of 10 pictures");
                                    }
                                  ...
                                  child: Container(
                                    ...
                                    child:  Row(
                                      ...
                                      children: [
                                        ...
                                        Icon(Icons.camera_alt_outlined, color: Constants.primaryColor,)
                                      ],
                                    ),
                                  ),
                                ),
                  ...
                  Divider(color: listingprovider.lightMode? null : listingprovider.getForegroundColor(),),
                  // Row(
                  //   children: [
                  //     Text('Title',
                  //       style: TextStyle(
                  ...
                  ExpansionTile(
                    ...
                    title: Text("Category", style: TextStyle(color: listingprovider.getForegroundColor()),),
                    tilePadding: EdgeInsets.only(left: 10, right: 10 ),
                    iconColor: Constants.greyColor,
                    // collapsedIconColor: Constants.greyColor,
                    trailing:  Icon(Icons.arrow_drop_down, color:listingprovider.lightMode? Colors.black : Colors.grey.withOpacity(0.7),),
                    subtitle: expanded?
                    Text("Select only One", style: TextStyle(color: listingprovider.getForegroundColor()),):  Container(
                      padding: EdgeInsets.only(top: 10),
                      height:expanded? 60: selectedCategory.length<4 && selectedCategory.isNotEmpty? 60: selectedCategory.isEmpty? 0 : 120,
                      ...
                      child: GridView.builder(
                          ...
                          itemBuilder: (BuildContext ctx, index) {
                            ...
                            return Container(
                              ...
                              child: Text(selectedCategory[index],
                          ...
                          children: [
                            Expanded(
                              child: PhysicalModel(
                                ...
                                elevation: 8,
                                shadowColor:listingprovider.lightMode? Color(0xFF000000): Color(0xFF303134) ,
                                color:listingprovider.lightMode? Colors.white: Color(0xFF303134) ,
                                ...
                                child: Container(
                                  ...
                                  child:
                                  ListView.builder(
                                      itemCount:  postprovider.categories.length~/2,
                                      itemBuilder: (context,index){

                                        return Row(
                                          children: [
                                            Checkbox(
                                                side: BorderSide(color: listingprovider.getForegroundColor()),

                                                value: postprovider.checks[index],
                                                onChanged: ( value){
                                                  ...
                                                  setState(() {
                                                    for (int index = 0; index < postprovider.categories.length; index++) {
                                                      if(index !=current){
                                                        postprovider.checks[index] = false;
                                                      } else if (index == current)  {
                                                        postprovider.checks[index] = !postprovider.checks[index];
                                            ...
                                            Text(postprovider.categories[index],
                                              style: TextStyle(
                                                  color: listingprovider.getForegroundColor()
                                              ),
                                            )
                                ...
                                child: Container(
                                  ...
                                  child:ListView.builder(
                                      ...
                                      itemBuilder: (context,index){
                                        ...
                                        if(index < postprovider.categories.length~/2  ) {
                                          return Container();
                                        }
                                        return Row(
                                          children: [
